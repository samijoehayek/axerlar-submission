                ...
                case "itsAssets":
                  ...
                  if (itsAssets) {
                    for (const [k, v] of Object.entries({
                      ...
                      if (i > -1)
                        itsAssets[i].price = itsAssets[i].price || v.price;
                    }
                  }
                  ...
                  setStats(
                    Object.fromEntries(
                      (
                                ...
                                new Promise(async (resolve) => {
                                  switch (d) {
                                    ...
                                    case "GMPTopITSAssets":
                                      resolve([
                                        d,
                                        await GMPTopITSAssets({ size: 100 }),
                                      ]);
                                      break;
                                    ...
                                    case "transfersStats":
                                      ...
                                      break;
                                    case "transfersChart":
                                      let value = await transfersChart({
                                        granularity: "month",
                                      });
                                      ...
                                      if (value?.data) {
                                        ...
                                        for (const airdrop of airdrops) {
                                          ...
                                          if (environment === ENVIRONMENT) {
                                            const _value = await transfersChart(
                                              {
                                                chain,
                                                fromTime,
                                                toTime,
                                    ...
                                    case "transfersTopUsers":
                                      resolve([
                                        d,
                                        await transfersTopUsers({ size: 100 }),
                                      ]);
                                      break;
                        ...
                        .map((d) => (Array.isArray(_.head(d)) ? d : [d]))
                        .flatMap((d) => d)
                    )
                  );
                default:
